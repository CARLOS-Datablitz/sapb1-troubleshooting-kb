...
chmod -R 777 Attachments/ && chown -R b1service0:b1service0 Attachments/ && ls -lha
...
echo '//sld.llamagas.nubeprivada.biz/B1_SHF/Attachments       /mnt/Attachments       cifs rw,guest,uid=b1service0,gid=b1service0,vers=3.0,iocharset=utf8,file_mode=0777,dir_mode=0777,noperm,nounix,x-systemd.automount 0 0'>>/etc/fstab

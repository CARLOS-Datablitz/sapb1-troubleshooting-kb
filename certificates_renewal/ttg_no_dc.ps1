...
$dcpw       = "BY8CyUvb"                #admin User Password on DC
$rnb        = "ttg"                        		#Domain Name
$fqdn       = "ttg.privatcloud.biz"        		#Fully Qualified Domain Name
$dcip       = "10.2.36.3"                    #IP from Domain Controller
$rdsip      = "10.2.36.4"                    #IP from RDS Server
$rdstcp     = "10049"                           #RDS Port
$tdc        = "adm.$fqdn"                        #DNS Server Name
...
$rdspfx     = 'c:\ttg.privatcloud.biz.pfx' #PFX file path
$rdscer     = 'c:\ttg.privatcloud.biz.cer' #CER file path

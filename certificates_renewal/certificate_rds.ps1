...
$dcpw       = "Ahs3wuk8"                #admin User Password on DC
$rnb        = "bodenfachmarkt"                        		#Domain Name
$fqdn       = "bodenfachmarkt.privatcloud.biz"        		#Fully Qualified Domain Name
$dcip       = "10.2.71.3"                    #IP from Domain Controller
$rdsip      = "10.2.71.5"                    #IP from RDS Server
$rdstcp     = "10089"                           #RDS Port
...
$rdspfx     = 'c:\bodenfachmarkt.privatcloud.biz.pfx' #PFX file path
$rdscer     = 'c:\bodenfachmarkt.privatcloud.biz.cer' #CER file path
